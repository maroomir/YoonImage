...
namespace YoonImage {
    ...
    Image::Image(unsigned char *pBuffer, int nWidth, int nHeight, eYoonImageFormat eFormat) {
        m_nWidth = nWidth;
        m_nHeight = nHeight;
    ...
    int Image::ToChannel(eYoonImageFormat eFormat) {
    ...
    eYoonImageFormat Image::ToImageFormat(int nChannel) {
        ...
        for (int iColor = 0; iColor < m_nChannel; iColor++) {
            ...
            for (int iY = 0; iY < m_nHeight; iY++) {
                for (int iX = 0; iX < m_nWidth; iX++) {
                    pResultBuffer[nStart + iY * m_nWidth + iX] = pMixedBuffer[iY * m_nWidth * m_nChannel +
                                                                              iX * m_nChannel + nColor];
                }
            }
        }
    ...
    unsigned char *Image::ToMixedColorBuffer(const unsigned char *pParallelBuffer, bool bReverseOrder) {
        ...
        for (int iColor = 0; iColor < m_nChannel; iColor++) {
            ...
            for (int iY = 0; iY < m_nHeight; iY++) {
                for (int iX = 0; iX < m_nWidth; iX++) {
                    pResultBuffer[iY * m_nWidth * m_nChannel + iX * m_nChannel + nColor] = pParallelBuffer[nStart + iY *
                                                                                                                    m_nWidth +
                                                                                                           iX];
                }
            }
    ...
    eYoonImageFormat Image::GetImageFormat() {
        return m_eFormat;
    }
